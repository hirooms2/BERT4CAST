...
import pickle
from layers import MultiHeadAttention, AdditiveAttention, Context_Aware_Att, Conv1D, BahdanauAttention
...
class NewsEncoder(nn.Module):
    def __init__(self, args, bert_model, tokenizer, word_embedding_path):
        ...
        self.linear_word = nn.Linear(args.glove_dim, args.hidden_size)
        # self.linear_query = nn.Linear(args.category_dim + args.subcategory_dim, args.hidden_size)
